...
import { initEnergyPicture, removeSeamRGB, computeEnergiesWithSIMD } from "./simd-energy";
...
export class SimdEngine implements Engine {
  ...
  shrink(): Uint8Array {
    ...
    const seam = findVerticalSeam(energies, this.imageWidth, this.imageHeight, numberOfPixels);
